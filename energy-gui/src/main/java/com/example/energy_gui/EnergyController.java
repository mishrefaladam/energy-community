...
public class EnergyController {
    ...
    protected void onShowDataClicked() {
        try {
            ...
            lb_communityProduced.setText(String.format("%.3f kWh", producedSum));
            lb_communityUsed.setText(String.format("%.3f kWh", usedSum));
            lb_gridUsed.setText(String.format("%.3f kWh", gridSum));
